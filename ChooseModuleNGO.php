        ...
        <div class="col-md-4 col-sm-4">
          <div class="price-table">
            ...
            <div class="price-in mart-15">
              <a href="ChooseBook.php" class="btn btn-bg green btn-block">Explore More</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-4">
          <div class="price-table">
            ...
            <!-- Plean Detail -->
            <div class="price-in mart-15">
              <a href="SearchFood.php" class="btn btn-bg yellow btn-block">Explore More</a>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-4">
          <div class="price-table">
            <!-- Plan  -->
            <div class="pricing-head">
              <h4>Receive Clothes</h4>
              <span class="fa fa-child"></span> 
            </div>

            <!-- Plean Detail -->
            <div class="price-in mart-15">
              <a href="Searchclothes.php" class="btn btn-bg red btn-block">Explore More</a>
            </div>
          </div>
        </div>
      </div>
