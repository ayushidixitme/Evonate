    ...
    <div class="container">
      <div class="row">
        <div class="header-section text-center">
          ...
          <p>Do a good deed today and give away the clothes you don't use anymore.</p>
        ...
        <div class="col-md-4 col-sm-4">
          ...
          <div class="price-table">
            ...
            <div class="price-in mart-15">
             <a href="clothesdonation.php"><button type="submit" class="btn btn-bg green btn-block">Proceed</button></a>
            </div>
          </div>
        </div>
        </div>
        <div class="col-md-4 col-sm-4">
          ...
          <div class="price-table">
            <!-- Plan  -->
            <div class="pricing-head">
              <h4>Collect Clothes</h4>
              <span class="fa fa-child"></span> 
            </div>

            <!-- Plean Detail -->
            <div class="price-in mart-15">
              <a href="Searchclothes.php"><button type="submit" class="btn btn-bg green btn-block" name="sfbbtn">Proceed</button></a>
            </div>
          </div>
        </div>
        </div>
