	...
	<form method="post" enctype="multipart/form-data">
		<div>
			...
			<h5 class="mb3 font-weight-normal">
				<center>
					<font face="Century Gothic" size="5">Sign in for good deeds!!</font>
				</center>
			</h5>
		...
		<div class="row">
			...
			<center class="form-group col-md-12">
				<a href="Ngo_Sign_in.php">Sign In with NGO</a>
			</center>
...
if (isset($signin)) {
	...
	if ($count != 0) {
		$arr = array();
		session_start();
		$_SESSION['First_Name'] = $n['fname'];
		$_SESSION['Last_Name'] = $n['lname'];
		...
		header("location:ChooseModule.php?email=" . $_SESSION['Email']);
	} else {
