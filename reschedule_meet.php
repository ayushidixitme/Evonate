...
if (isset($_POST["BookId"]) ) {
   ...
   // echo $qry;
    ...
    if ($result) {
        ...
        //$mail->addAttachment('img/attachment.png');
        //Email body
        $mail->Body = '<h1>Hello,<h1> <br/> Hi,<br/> Your meeting is set to the reciver, ' . $_POST["name"] . ' via ' . $_POST["contactvia"] . ' 
        on ' . $_POST["date"] . ' at ' . $_POST["time"] . '. Please reach out to the receiver. <br/><br/><h2>Evonate</h2> ';
        //Add recipient
        $mail->addAddress($ide);
        //Finally send email
        if ($mail->send()) {
    ...
    <form method="post" enctype="multipart/form-data" onsubmit="return validateOTP()">
        ...
        <div class="form-group">
            <h5 class="mb3 font-weight-normal">
                <center>You can only Reschedule once.</center>
            </h5>
        </div>
...
, receiver.Userid `rid`
            ...
            <label class='col-md-4'>$r[email]</label>
            </div> 
            <div class='form-group'>
            <label class='col-md-4'>Mobile</label>
            <label class='col-md-4'>$r[phone]</label>
            </div> 
            <div class='form-group'>
...
";
            ...
            echo "<input hidden value='$r[rid]' id='id' name='id' />";
                ...
                <?php if (isset($success_msg)) { ?>
                    ...
                    <div class='form-group'>
                        <label class='col-md-4'><button name="confirm" class="btn btn-lg btn-success btn-block" type="submit">Confirm Reschedule</button></label>
                    </div>
